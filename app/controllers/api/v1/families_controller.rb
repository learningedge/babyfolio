class Api::V1::FamiliesController < ApplicationController
  ...
  def make_admin      
      ...
      redirect_to api_v1_settings_f_and_f_path(:family_id => family_id)
  end
  ...
  def update_relation
    ...
    redirect_to api_v1_settings_f_and_f_path 
  end
  ...
  def resend_invitation
    ...
    if relation.child.family.is_admin?(current_user)
      ...
      flash[:notice] = "Reminder has been sucessfully sent."
    else
      flash[:notice] = "There were some errors while send reminder, please try again later."
    end
    redirect_to api_v1_settings_f_and_f_path
