      ...
      if @authhash[:uid] != '' and @authhash[:provider] != ''
        ...
        if user_signed_in?
          if auth
            ...
            redirect_to 'families/new'#services_path
          else
...
#            @user = User.new(:email => @authhash[:email], :first_name => @authhash[:name], :password => 'admin', :password_confirmation => 'admin', :email_confirmed => 1)
